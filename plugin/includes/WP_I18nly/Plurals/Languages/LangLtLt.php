...
final class LangLtLt implements LanguageSpecProvider {
	...
	public static function get_spec() {
		$spec = array(
			'nplurals'          => 3,
			'plural_expression' => '((n % 10 == 1 && (n % 100 < 11 || n % 100 > 19)) ? 0 : ((n % 10 >= 2 && n % 10 <= 9 && (n % 100 < 11 || n % 100 > 19)) ? 1 : 2))',
			'forms'             => array(),
		);
		...
		$spec['forms'][] = array(
			...
			'label'    => __( 'b', 'i18nly' ),
			/* translators: Tooltip explaining when this plural form input should be used in the translation editor. */
			'tooltip'  => __( '2, 3, 4, 5, ...', 'i18nly' ),
			'examples' => array( 2, 3, 4, 7, 8 ),
		);
		$spec['forms'][] = array(
			/* translators: Short label identifying one plural form input in the translation editor. */
			'label'    => __( 'c', 'i18nly' ),
