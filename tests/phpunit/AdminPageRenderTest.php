...
class AdminPageRenderTest extends TestCase {
	...
	public function test_register_translation_meta_box_delegates_to_translation_edit_controller() {
		...
		$page = new class( $controller ) extends \WP_I18nly\Admin\AdminPage {
			/**
	...
	public function test_filter_translation_list_columns_delegates_to_list_columns_handler() {
		...
		$page = new class( $handler ) extends \WP_I18nly\Admin\AdminPage {
			/**
	...
	public function test_render_translation_meta_box_delegates_to_meta_box_renderer() {
		...
		$page = new class( $renderer ) extends \WP_I18nly\Admin\AdminPage {
			/**
	...
	public function test_delegates_translation_access_to_repository() {
		...
		$page = new class( $repository ) extends \WP_I18nly\Admin\AdminPage {
			/**
	...
	public function test_delegates_plugin_metadata_to_provider() {
		...
		$page = new class( $provider ) extends \WP_I18nly\Admin\AdminPage {
			/**
	...
	public function test_delegates_entries_persistence_to_persister() {
		...
		$page = new class( $persister ) extends \WP_I18nly\Admin\AdminPage {
			/**
	...
	public function test_register_menu_delegates_to_admin_registration_service() {
		...
		$page = new class( $registration ) extends \WP_I18nly\Admin\AdminPage {
			/**
	...
	public function test_render_translation_edit_script_delegates_current_edit_resolution() {
		...
		$page = new class( $resolver ) extends \WP_I18nly\Admin\AdminPage {
			/**
